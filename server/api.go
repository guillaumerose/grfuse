...
type FileSystem interface {
	...
	GetAttr(name string, context *fuse.Context) (*pb.Attr, fuse.Status)
	...
	Open(name string, flags uint32, context *fuse.Context) (file File, code fuse.Status)

	// Directory handling
	OpenDir(name string, context *fuse.Context) (stream []pb.DirEntry, code fuse.Status)
