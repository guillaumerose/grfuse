...
// defaultFileSystem
func (fs *defaultFileSystem) GetAttr(name string, context *fuse.Context) (*pb.Attr, fuse.Status) {
...
func (fs *defaultFileSystem) Open(name string, flags uint32, context *fuse.Context) (file File, code fuse.Status) {
	return nil, fuse.ENOSYS
}
...
func (fs *defaultFileSystem) Create(name string, flags uint32, mode uint32, context *fuse.Context) (file File, code fuse.Status) {
	return nil, fuse.ENOSYS
}
func (fs *defaultFileSystem) OpenDir(name string, context *fuse.Context) (stream []pb.DirEntry, code fuse.Status) {
	return nil, fuse.ENOSYS
}
